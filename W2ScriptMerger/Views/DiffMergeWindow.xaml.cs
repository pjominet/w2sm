...
public partial class DiffMergeWindow : Window
{
    ...
    {
        if (_conflict.VanillaContent is not null)
        {
    ...
    private void CopyFromVanilla_Click(object sender, RoutedEventArgs e)
    {
        UseVanilla_Click(sender, e);
    }

    private void CopyFromMod_Click(object sender, RoutedEventArgs e)
    {
        UseMod_Click(sender, e);
    }
